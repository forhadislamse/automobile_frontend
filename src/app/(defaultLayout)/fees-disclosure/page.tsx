...
export default function FeesDisclosurePage() {
  ...
  const sections: FeeSection[] = [
    {
      id: "overview",
      title: "SmartAutoTech Fees Disclosure",
      icon: Info,
      tags: ["overview", "subscription", "paid", "access", "tools", "features"],
      content: (
        <p className="text-gray-600 dark:text-gray-300 leading-relaxed font-medium">
          SmartAutoTech is a subscription-based platform. Access to certain features, diagnostic tools, and user accounts may require an active paid subscription.
        </p>
      )
    },
    {
      ...
      icon: CreditCard,
      tags: ["billing", "subscription", "fees", "monthly", "annually", "signup", "taxes"],
      content: (
        <div className="space-y-2">
          <ul className="list-disc pl-6 space-y-1.5 text-gray-600 dark:text-gray-300">
            ...
            <li>Subscription pricing is displayed during signup and account selection</li>
            <li>Fees are subject to applicable taxes where required</li>
          </ul>
        </div>
      )
    },
    {
      ...
      icon: RefreshCw,
      tags: ["renewal", "automatic", "renew", "canceled", "date"],
      content: (
    ...
    },
    {
      ...
      title: "Cancellation",
      icon: Ban,
      tags: ["cancellation", "cancel", "active", "billing", "period", "settings"],
      content: (
        <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
          Users may cancel their subscription at any time through their account settings. Access to paid features will remain active through the current billing period.
        </p>
      )
    },
    {
      ...
      icon: TrendingUp,
      tags: ["pricing", "changes", "modify", "notice", "subscribers"],
      content: (
        <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
          SmartAutoTech reserves the right to modify subscription pricing with reasonable notice to subscribers.
        </p>
      )
    },
    {
      ...
      icon: DollarSign,
      tags: ["non-refundable", "refund", "fees", "paid"],
      content: (
        <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
          Unless otherwise stated, subscription fees already paid are non-refundable.
        </p>
      )
    }
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-8 md:mb-12 print:mb-6">
        <div className="relative rounded-3xl overflow-hidden bg-gradient-to-br from-[#042055] via-[#093582] to-[#124ca6] p-8 md:p-14 text-white shadow-xl shadow-[#042055]/10">
          ...
          <div className="flex items-center gap-2 mb-4">
            <span className="text-xs md:text-sm font-bold uppercase tracking-wider text-blue-200">Financial Terms</span>
          </div>

          {/* Heading */}
          <h1 className="text-3xl md:text-5xl font-black tracking-tight mb-4">
            SmartAutoTech Fees Disclosure
          </h1>
          ...
          <div className="flex flex-wrap items-center justify-between gap-4 pt-6 border-t border-white/10 text-xs md:text-sm text-blue-200">
            <div className="flex flex-wrap gap-x-6 gap-y-2">
              ...
              <div>
                ...
                <span className="font-semibold text-white">All Subscribers</span>
              </div>
            </div>
          ...
          <div className="lg:col-span-1 print:hidden">
            <div className="sticky top-28 space-y-6">
              ...
              <div className="relative rounded-2xl bg-white dark:bg-gray-900 border border-gray-200/80 dark:border-gray-800 p-3 shadow-sm">
                <Label htmlFor="search" className="sr-only">Search Disclosures</Label>
              ...
              <div className="rounded-2xl bg-white dark:bg-gray-900 border border-gray-200/80 dark:border-gray-800 p-4 shadow-sm space-y-3">
                ...
                <nav className="space-y-1 max-h-[350px] overflow-y-auto pr-1">
                  ...
                  {filteredSections.length === 0 && (
                    <p className="text-xs text-gray-400 italic py-4 text-center">No sections match your search.</p>
                  )}
                </nav>
              </div>
              ...
              {/* <div className="rounded-2xl bg-gradient-to-br from-gray-900 to-gray-800 dark:from-gray-950 dark:to-gray-900 p-5 text-white shadow-md relative overflow-hidden">
                ...
                <h4 className="text-sm font-bold mb-1">Billing Support?</h4>
                <p className="text-xs text-gray-300 leading-relaxed mb-4">
                  For subscription inquiries, invoicing questions, or plan downgrades, connect with our support.
                </p>
                <Link
            ...
            {filteredSections.length === 0 && (
              <div className="text-center py-16 px-4 rounded-3xl bg-white dark:bg-gray-900 border border-gray-200/80 dark:border-gray-800">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400 max-w-sm mx-auto mb-6">
                  We couldn't find any financial disclosures matching "{searchQuery}". Try searching for broader terms like "billing", "cancel", or "pricing".
                </p>
                <button
              ...
              <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
                <div className="space-y-2 max-w-xl">
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400 leading-relaxed">
                    By subscribing to any plan on the SmartAutoTech platform, you signify your full agreement with our billing policies, renewal terms, and cancellation guidelines.
                  </p>
                </div>
